...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(BAL_ATTRITION_DAMAGE, 5),
	GD_INT_INIT(BAL_HEAVY_CHARGE_NO_RETREAT_MODIFIER, 25),
	GD_INT_INIT(BAL_HEAVY_CHARGE_RETREAT_MAX_HP, 100),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(BAL_ATTRITION_DAMAGE);
	GD_INT_CACHE(BAL_HEAVY_CHARGE_NO_RETREAT_MODIFIER);
	GD_INT_CACHE(BAL_HEAVY_CHARGE_RETREAT_MAX_HP);
