...
public:
	...
	{
		SAVE_VERSION_INITIAL = 0,
		SAVE_VERSION_MILITARY_LOG = 1,
		SAVE_VERSION_LATEST = SAVE_VERSION_MILITARY_LOG,
	};
	...
	GD_INT_MEMBER(BAL_ATTRITION_DAMAGE);
	GD_INT_MEMBER(BAL_HEAVY_CHARGE_NO_RETREAT_MODIFIER);
	GD_INT_MEMBER(BAL_HEAVY_CHARGE_RETREAT_MAX_HP);
